<?php 
//ESTA SUB RUTINA IMPRIME LAS GRAFICAS PARA INDICADORES-prentas
if(isset($_POST['vendedor']) and isset($_POST['ano']) and isset($_POST['mes']) and isset($_POST['edad']) and isset($_POST['cliente']) and isset($_POST['producto'])){
	...
	echo "
		<div class='row py-2 px-1'>
			<div class='col-lg-5 mx-auto'>
				<canvas id='preguntas_mes_a_mes'></canvas>
			</div>
		</div>
	";
	if(isset($_POST['user'])){
		echo "
			<div class='row py-2 px-1'>
				<div class='col-7 col-md-4 col-lg-3 mx-auto'>
					<canvas id='preguntas_torta_edades'></canvas>
				</div>
				<div class='col-7 col-md-4 col-lg-3 mx-auto'>
					<canvas id='preguntas_torta_clientes'></canvas>
				</div>
				<div class='col-7 col-md-4 col-lg-3 mx-auto'>
					<canvas id='preguntas_torta_productos'></canvas>
				</div>
			</div>
		";
	}else{
		echo "
			<div class='row py-2'>
				<div class='col-7 col-md-6 col-lg-3 mx-auto'>
					<canvas id='preguntas_torta_vendedores'></canvas>
				</div>
				<div class='col-7 col-md-6 col-lg-3 mx-auto'>
					<canvas id='preguntas_torta_edades'></canvas>
				</div>
	...
	$datos_graf_1=M_indicadores_R_graf_6($conexion, $_POST['vendedor'], $_POST['ano'], $_POST['mes'], $_POST['edad'], $_POST['cliente'], $_POST['producto']);
	echo "
		<script>
			var ctx = document.getElementById('preguntas_mes_a_mes').getContext('2d');
	...
	echo "
				...
				options: {
					...
					title: {
						display: true,
						text: 'Total: " . $datos_graf_1['TOTAL_VISTAS'][0] . " Preguntas'
					},
					tooltips: {
						mode: 'index',
						intersect: false,
	...
	";
	$datos_torta_3=M_indicadores_R_graf_6_torta_edades($conexion, $_POST['vendedor'], $_POST['ano'], $_POST['mes'], $_POST['edad'], $_POST['cliente'], $_POST['producto']);	
	echo "
		<script>
			var ctx = document.getElementById('preguntas_torta_edades').getContext('2d');
			var chart = new Chart(ctx, {
				type: 'pie',
				data: {
					labels: [
	...
	echo "
				...
				options: {
					...
					title: {
							display: true,
							text: '" . $datos_graf_1['TOTAL_VISTAS'][0] . " ? / " . $i . " Edades',
							fontSize: 14,
							fontColor: '#333'
					}
				}
	...
	";
	$datos_torta_4=M_indicadores_R_graf_6_torta_clientes($conexion, $_POST['vendedor'], $_POST['ano'], $_POST['mes'], $_POST['edad'], $_POST['cliente'], $_POST['producto']);	
	echo "
		<script>
			var ctx = document.getElementById('preguntas_torta_clientes').getContext('2d');
			var chart = new Chart(ctx, {
				type: 'pie',
				data: {
					labels: [
	...
	echo "
				...
				options: {
					...
					title: {
							display: true,
							text: '" . $datos_graf_1['TOTAL_VISTAS'][0] . " ? / ";
	...
	";
	$datos_torta_5=M_indicadores_R_graf_6_torta_productos($conexion, $_POST['vendedor'], $_POST['ano'], $_POST['mes'], $_POST['edad'], $_POST['cliente'], $_POST['producto']);	
	echo "
		<script>
			var ctx = document.getElementById('preguntas_torta_productos').getContext('2d');
			var chart = new Chart(ctx, {
				type: 'pie',
				data: {
					labels: [
	...
	";
	$datos_torta_6=M_indicadores_R_graf_6_torta_vendedores($conexion, $_POST['vendedor'], $_POST['ano'], $_POST['mes'], $_POST['edad'], $_POST['cliente'], $_POST['producto']);	
	echo "
		<script>
			var ctx = document.getElementById('preguntas_torta_vendedores').getContext('2d');
			var chart = new Chart(ctx, {
				type: 'pie',
				data: {
					labels: [
