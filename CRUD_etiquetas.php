	...
	?>
			<div class="col-md-12 col-lg-10 col-xl-9 mx-auto bg-dark">
				...
				<form action="CRUD_etiquetas.php" method="post" class="text-center bg-dark p-2 rounded">
					...
					<div class="m-auto">
						<a href="CRUD_etiquetas.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;<input type="submit" value="Insertar Nuevo Renglón &raquo;" class="btn btn-warning mb-2">
					</div>
				</form>
			</div>
		...
		?>
			<div class="col-md-12 col-lg-10 col-xl-9 mx-auto bg-dark">
				...
				<form action="CRUD_etiquetas.php" method="post" class="text-center bg-dark p-2 rounded">
					...
					<div class="m-auto">
						<a href="CRUD_etiquetas.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;<input type="submit" value="Modificar Renglón &raquo;" class="btn btn-warning mb-2">
					</div>
				</form>
			</div>
			<br><br><br><br><br><br><br><br>
		...
		<div class="col-md-12 col-lg-9 mx-auto">
			<form action="CRUD_etiquetas.php" method="post" class="text-center bg-dark p-2 rounded">
				...
				<div class="m-auto">
					<a href="CRUD_etiquetas.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;<input type="submit" value="Borrar Renglón &raquo;" class="btn btn-warning mb-2">
				</div>
			</form>
			<br><br><br><br><br><br><br><br>
		</div>
