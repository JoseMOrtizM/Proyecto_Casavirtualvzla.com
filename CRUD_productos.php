...
if(isset($_POST['FORM'])){
	if($_POST['FORM']=='INSERTAR'){
		...
		//PONIENDO PRODUCTO COMO REVISADO
		M_productos_y_servicios_U_id_revisado($conexion, $id_producto, "SI");
		//MOVIENDO FOTOS A LA CARPETA IMAGENES_PRODUCTOS
		if($verf_foto_size_1=='ok' and $verf_foto_type_1=='ok'){
			//MOVIENDO IMAGEN A LA CARPETA DE FOTOS_DE_EMPLEADOS DEL PROYECTO
...
<body class="bg-secondary">
		...
		<div class="col-md-12 col-lg-10 col-xl-9 mx-auto bg-dark">
			<div class="row mt-4 align-items-center rounded-top px-2">
				<div class="col-md-9 mb-1 mt-3">
					<h3 class="text-center text-md-left text-warning">Agregar nuevo Producto:</h3>
				</div>
				<div class="col-md-3 text-center text-md-right mb-1 mt-3">
					<a href="CRUD_productos.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>
				</div>
			</div>
			<form action="CRUD_productos.php" method="post" class="text-center bg-dark p-2 rounded" enctype="multipart/form-data">
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-9 p-0 m-0 px-2 rounded-0" name="nombre_prod" id="nombre_prod" placeholder="Nombre del producto" required autocomplete="off" title="Introduzca el nombre del producto">
				</div>
				<div class="input-group mb-2 text-left">
					<span class="input-group-text rounded-0 w-100">Descripción:</span>
					<textarea class="form-control p-0 m-0 px-2 rounded-0" name="descripcion_prod" id="descripcion_prod" placeholder="Descripción del Producto" required autocomplete="off" title="Introduzca la Descripción del Producto" rows="2"></textarea>
				</div>
				<script>
				...
				<div class="input-group mb-2 text-left">
					...
					<textarea class="form-control p-0 m-0 px-2 rounded-0" name="caracteristicas_prod" id="caracteristicas_prod" placeholder="Características del Producto" required autocomplete="off" title="Introduzca las Características del Producto" rows="2"></textarea>
				</div>
				<script>
					$(document).ready(function() {
				...
				<div class="input-group mb-2">
					...
					<input type="number" class="form-control col-md-7 p-0 m-0 px-2 rounded-0" name="cant_disponible" id="cant_disponible" placeholder="Cantidad disponible" required autocomplete="off" title="Cantidad disponible para la venta">
				</div>
				<div class="input-group mb-2">
				...
				<div class="m-auto">
					<a href="CRUD_productos.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;<input type="submit" value="Insertar Renglón &raquo;" class="btn btn-warning mb-2">
				</div>
			</form>
		</div>
		<?php
			...
			<form action="CRUD_productos.php" method="post" class="text-center bg-dark p-2 rounded" enctype="multipart/form-data">
				...
				<div class="input-group mb-2">
					<?php
						...
						$palabras=explode(" ", str_replace(">", " ", str_replace("<", " ", $datos_actualizar['NOMBRE_PRODUCTO'][0])));
						$contador_ii=0;
					...
					<div class="col-md-3 p-0 m-0">
						<span class="input-group-text rounded-0 w-100">
							...
							<?php
								if($verf_groceria){
									echo " <b title='Existen Malas Palabras en este nombre'><span class='btn btn-transparent text-danger fa fa-exclamation-triangle d-inline'></span></b>";
								}
							?>
						</span>
					</div>
				...
				<div class="input-group mb-2 text-left">
					<?php
						...
						$verf_groceria=false;
						$grocerias=M_palabras_prohibidas();
						$palabras=explode(" ", str_replace(">", " ", str_replace("<", " ", $datos_actualizar['DESCRIPCION_PRODUCTO'][0])));
						$contador_ii=0;
						while(isset($palabras[$contador_ii])){
							$contador_iii=0;
							while(isset($grocerias[$contador_iii])){
					...
					<span class="input-group-text rounded-0 w-100">
						...
						<?php
							if($verf_groceria){
								echo " <b title='Existen Malas Palabras en esta descripción'><span class='btn btn-transparent text-danger fa fa-exclamation-triangle d-inline'></span></b>";
							}
						?>
					</span>
					<?php
						...
						$texto_a_imprimir="";
						$grocerias=M_palabras_prohibidas();
						$palabras=explode(" ", str_replace(">", html_entity_decode("> "), str_replace("<", html_entity_decode(" <"), $datos_actualizar['DESCRIPCION_PRODUCTO'][0])));
						$contador_ii=0;
						while(isset($palabras[$contador_ii])){
							$contador_iii=0;
							$verf_groceria=false;
					...
					?>
					<textarea class="form-control p-0 m-0 px-2 rounded-0" name="descripcion_prod" id="descripcion_prod" placeholder="Introduzca la Descripción del Producto" required autocomplete="off" title="Introduzca la Descripción del Producto" rows="2"><?php echo $texto_a_imprimir; ?></textarea>
				</div>
				<script>
					$(document).ready(function() {
						$('#descripcion_prod').summernote({
				...
				<div class="input-group mb-2 text-left">
					<?php
						...
						$verf_groceria=false;
						$grocerias=M_palabras_prohibidas();
						$palabras=explode(" ", str_replace(">", " ", str_replace("<", " ", $datos_actualizar['CARACTERISTICAS_PRODUCTO'][0])));
						$contador_ii=0;
						while(isset($palabras[$contador_ii])){
							$contador_iii=0;
							while(isset($grocerias[$contador_iii])){
					...
					<span class="input-group-text rounded-0 w-100">
						...
						<?php
							if($verf_groceria){
								echo " <b title='Existen Malas Palabras en estas características'><span class='btn btn-transparent text-danger fa fa-exclamation-triangle d-inline'></span></b>";
							}
						?>
					</span>
					<?php
						...
						$texto_a_imprimir="";
						$grocerias=M_palabras_prohibidas();
						$palabras=explode(" ", str_replace(">", html_entity_decode("> "), str_replace("<", html_entity_decode(" <"), $datos_actualizar['CARACTERISTICAS_PRODUCTO'][0])));
						$contador_ii=0;
						while(isset($palabras[$contador_ii])){
							$contador_iii=0;
							$verf_groceria=false;
					...
					?>
					<textarea class="form-control p-0 m-0 px-2 rounded-0" name="caracteristicas_prod" id="caracteristicas_prod" placeholder="Introduzca las Características del Producto" autocomplete="off" title="Introduzca las Características del Producto" rows="2"><?php echo $texto_a_imprimir; ?></textarea>
				</div>
				<script>
					$(document).ready(function() {
						$('#caracteristicas_prod').summernote({
				...
				<div class="m-auto">
					<a href="CRUD_productos.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;<input type="submit" value="Modificar Renglón &raquo;" class="btn btn-warning mb-2">
				</div>
			</form>
		</div>
	<?php
		...
		<div class="col-md-12 col-lg-9 mx-auto">
			<form action="CRUD_productos.php" method="post" class="text-center bg-dark p-2 rounded">
				...
				<div class="m-auto">
					<a href="CRUD_productos.php" class="btn btn-warning text-dark mb-2"><span class="fa fa-reply-all"></span> Volver</a>&nbsp;&nbsp;<input type="submit" value="Borrar Renglón &raquo;" class="btn btn-warning mb-2">
				</div>
			</form>
		...
		?>
		<META HTTP-EQUIV="Refresh" CONTENT="0; URL=CRUD_productos.php">
	<?php
	...
	?>
	<?php
		//obteniendo los datos de los productos no revisados:
		$datos_sr=M_productos_y_servicios_R($conexion, 'REVISADO', 'NO', '', '', '', '');
		if(isset($datos_sr['ID_PRODUCTO'][0])){
			if($datos_sr['ID_PRODUCTO'][0]<>""){
	?>
	<!-- TABLA PRODUCTOS SIN REVISAR -->
	<div class="card mb-3 bg-dark rounded-0 col-12 col-lg-9 mx-auto px-0">
		<div class="card-header text-center text-danger">
			<h3 class='text-center'><span class="fa fa-database"></sapn> Sin revisar:</h3>
				...
				<table class="table table-bordered table-striped table-hover TablaDinamica">
					<thead>
						<tr class="text-center">
							<th class="align-middle"><b title="Foto y Nombre del Producto">Producto</b></th>
							<th class="align-middle h5 p-0"><a title="Insertar" href="CRUD_productos.php?accion=insertar" class="h3 btn btn-transparent text-primary fa fa-share-square-o"><br>Insertar</a></th>
						</tr>
					</thead>
					<tbody>
						<?php
						$i=0;
						while(isset($datos_sr['ID_PRODUCTO'][$i])){
							if($datos_sr['ID_PRODUCTO'][$i]<>""){
								echo "<tr>";
								echo "<td class='text-left'><div class='Container'><div class='row'><div class='col-6 col-sm-5 col-md-4 col-lg-3 col-xl-2 ml-0'><img src='IMAGENES_PRODUCTOS/" . $datos_sr['FOTO_1'][$i] . "?a=" . rand() . "' class='w-100 imgFit'></div><div class='col-12 col-sm-7 col-md-8 col-lg-9 col-xl-10 ml-0'><b class='text-danger'>" . $datos_sr['NOMBRE_PRODUCTO'][$i] . "</b><br>";
								echo "<b>P/U:</b> " . $datos_sr['PRECIO_UNITARIO_MICOIN'][$i] . " Pm/" . $datos_sr['UNIDAD_DE_VENTA'][$i] . "<br><b>Disponible:</b> " . $datos_sr['CANTIDAD_DISPONIBLE'][$i] . "<br><b>Categoría:</b> " . $datos_sr['NOMBRE_CATEGORIA'][$i] . "</div></div></td>";
								echo "<td class='text-center h5'>";
								// VERIFICANDO SI EXISTEN MALAS PALABRAS
								$verf_groceria=false;
								$grocerias=M_palabras_prohibidas();
								$palabras=explode(" ", str_replace(">", " ", str_replace("<", " ", $datos_sr['NOMBRE_PRODUCTO'][$i] . " " . $datos_sr['DESCRIPCION_PRODUCTO'][$i] . " " . $datos_sr['CARACTERISTICAS_PRODUCTO'][$i])));
								$contador_ii=0;
								while(isset($palabras[$contador_ii])){
									$contador_iii=0;
									while(isset($grocerias[$contador_iii])){
								...
								if($verf_groceria){
									echo "<b title='Existen Malas Palabras en este producto'><span class='btn btn-transparent text-danger fa fa-exclamation-triangle d-inline'></span></b><br>";
								}
								echo "<a title='Ver publicación' href='zona_usuario_detalle_producto.php?id_producto=" . $datos_sr['ID_PRODUCTO'][$i] . "' class='btn btn-transparent text-primary fa fa-eye d-inline'></a></a>";
								echo "<br>";
								echo "<a title='Modificar' href='CRUD_productos.php?accion=actualizar&NA_Id=" . $datos_sr['ID_PRODUCTO'][$i] . "' class='btn btn-transparent text-success fa fa-edit d-inline'></a>";
								echo "<br>";
								echo "<a title='Eliminar' href='CRUD_productos.php?accion=borrar&NA_Id=" . $datos_sr['ID_PRODUCTO'][$i] . "' class='btn btn-transparent text-danger fa fa-trash-o d-inline'></a></td>";
								echo "</tr>";
							}
							$i=$i+1;
						}
	...
	<div class="card mb-3 bg-dark rounded-0 col-12 col-lg-9 mx-auto px-0">
		<div class="card-header text-center text-warning">
			<h3 class='text-center'><span class="fa fa-database"></sapn> Productos:</h3>
			<h6 class='text-center small text-light'>Para ver productos con malas palabras Buscar por xxx:</h6>
		</div>
		<div class="card-body px-1 bg-white">
			<div class="table-responsive">
					...
					<tbody>
						...
						while(isset($datos['ID_PRODUCTO'][$i])){
							if($datos['ID_PRODUCTO'][$i]<>""){
								...
								$verf_groceria=false;
								$grocerias=M_palabras_prohibidas();
								$palabras=explode(" ", str_replace(">", " ", str_replace("<", " ", $datos['NOMBRE_PRODUCTO'][$i] . " " . $datos['DESCRIPCION_PRODUCTO'][$i] . " " . $datos['CARACTERISTICAS_PRODUCTO'][$i])));
								$contador_ii=0;
								while(isset($palabras[$contador_ii])){
									$contador_iii=0;
									while(isset($grocerias[$contador_iii])){
								...
								echo "<a title='Ver publicación' href='zona_usuario_detalle_producto.php?id_producto=" . $datos['ID_PRODUCTO'][$i] . "' class='btn btn-transparent text-primary fa fa-eye d-inline'></a></a>";
								echo "<br>";
								echo "<a title='Modificar' href='CRUD_productos.php?accion=actualizar&NA_Id=" . $datos['ID_PRODUCTO'][$i] . "' class='btn btn-transparent text-success fa fa-edit d-inline'></a>";
								echo "<br>";
								echo "<a title='Eliminar' href='CRUD_productos.php?accion=borrar&NA_Id=" . $datos['ID_PRODUCTO'][$i] . "' class='btn btn-transparent text-danger fa fa-trash-o d-inline'></a></td>";
								echo "</tr>";
							}
							$i=$i+1;
						}
